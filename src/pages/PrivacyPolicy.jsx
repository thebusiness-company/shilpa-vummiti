  ...
  return (
    <div className="flex justify-center min-h-screen">
      <div className="bg-white w-full px-4 mt-8 lg:mt-12 mb-6 lg:mb-10 max-w-[94%] md:max-w-[90%]">
        ...
        <div className="flex flex-col items-center py-6 px-4 md:px-8 space-y-6 text-sm md:text-base leading-relaxed">
          ...
          <div className="w-full text-left space-y-6 ">
            <section className="mt-3">
              <p className="text-center ">
                ...
                Company collects, uses, discloses, and
                safeguards personal information obtained from users you
                when accessing or using our website, visiting our
            ...
            <section className="space-y-4 mt-10">
              <h2 className="text-lg md:text-xl">1. Scope</h2>
              <p className=" ">
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">2. Information We Collect</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">3. Purpose of Processing</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">7. Data Retention</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">8. Data Security</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">10. Your Rights</h2>
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">11. Children’s Data</h2>
              <p>
            ...
            <section className="space-y-4">
              <h2 className="text-lg md:text-xl">12. Updates to This Policy</h2>
              <p>
