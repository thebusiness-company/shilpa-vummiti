...
const PersonalizationSection = () => {
  ...
  return (
    <section className="px-2 py-8 w-full max-w-[90%] mx-auto bg-white text-center">
      <h2 className="text-2xl lg:text-3xl mb-6 mt-4 md:mb-10 font-tenor">Personalization</h2>

      <div className="grid grid-cols-2 sm:grid-cols-4 gap-6 mb-8">
        <img src={p1} alt="Look 1" className="w-full h-auto" />
        <img src={p2} alt="Look 2" className="w-full h-auto" />
        <img src={p3} alt="Look 3" className="w-full h-auto" />
        <img src={p4} alt="Look 4" className="w-full h-auto" />
      </div>

      <p className="text-sm lg:text-xl font-medium mb-6 font-tenor">
        Looking For A One-Of-A-Kind Dress That Perfectly Fits Your Style And Body?
      </p>

      <p className="w-full mx-auto text-sm md:text-base lg:text-lg mb-6">
