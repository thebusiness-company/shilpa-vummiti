      ...
      {!showProducts ? (
        ...
        <div>
            ...
            {products?.data.map((prod) => (
              <div key={prod.id} className="text-center group relative">
                <Link to={`/productDetail/${prod.slug}`}>
                  ...
                  />
                  <p className="mt-2 font-medium text-sm sm:text-base lg:text-lg 2xl:text-xl text-left text-[#183028] font-tenor lg:font-medium">
                    {prod.name}
                  </p>
                  <p className="text-sm sm:text-base lg:text-lg 2xl:text-xl text-left text-[#183028] font-tenor">
                    ₹ {prod.price}
                  </p>
                </Link>
                {/* wishlist button */}
          ...
          <div className="flex justify-between mt-6 font-palanquin text-[#183028] lg:hidden">
            <button onClick={handleViewLess} className="underline text-xl">
              View Less
            </button>
            <button onClick={handleViewMore} className="underline text-xl">
              View More
            </button>
          </div>
